...
import com.sales.controller.Guide;
...
public class InvGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        createLineButton.addActionListener(guide);
        deleteLineButton = new javax.swing.JButton();
        deleteLineButton.addActionListener(guide);
        jMenuBar1 = new javax.swing.JMenuBar();
        jMenu1 = new javax.swing.JMenu();
        loadInv = new javax.swing.JMenuItem();
        loadInv.addActionListener(guide);
        savInv = new javax.swing.JMenuItem();
        savInv.addActionListener(guide);
        ...
        savInv.setText("Save Invoice");
        savInv.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                savInvActionPerformed(evt);
            }
        });
        jMenu1.add(savInv);
    ...
    private void savInvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savInvActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_savInvActionPerformed
    ...
    public InvTable getInvoicesTableModel() {
        if (invoicesTableModel == null) {
            invoicesTableModel = new InvTable(getInvoices());
        }
        return invoicesTableModel;
    }

    public void setInvoicesTableModel(InvTable invoicesTableModel) {
